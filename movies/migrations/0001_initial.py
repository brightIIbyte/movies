    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='указвать сумму в долларах', verbose_name='Бюджет')),
                ('fess_in_usa', models.PositiveIntegerField(default=0, help_text='указвать сумму в долларах', verbose_name='Сборы в США')),
                ('fess_in_world', models.PositiveIntegerField(default=0, help_text='указвать сумму в долларах', verbose_name='Сборы в Мире')),
